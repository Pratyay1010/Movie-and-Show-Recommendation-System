...
show_df = pickle.load(open("pages/external_files/Pickle_Files/shows_df.pkl", "rb"))
similarities = pickle.load(open("pages/external_files/Pickle_Files/similarities.pkl", "rb"))
